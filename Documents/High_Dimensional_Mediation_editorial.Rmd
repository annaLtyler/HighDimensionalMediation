...
(Figure \ref{fig:trait_overview}D $R^2 =$ `r pheno.stats$food_weight["r"]`,
...
of the genome on metabolic traits (Fig \ref{fig:workflow}). Figure 
...
Figure \ref{fig:workflow}C illustrates this observation in more detail. 
...
significantly different from the null (Figure \ref{fig:workflow}B), 
...
Body weight contributed the most (Figure \ref{fig:interpretation}), 
...
on the HFHS diet) (Figure \ref{fig:interpretation}C-D). 
...
metabolic disease on the HFHS diet) (Figure \ref{fig:interpretation}C-D). 
...
(Supplementary Figures \ref{fig:top_enrich_kegg} and \ref{fig:top_enrich_go}).
...
skeletal muscle were the weakest (Figure \ref{fig:loading_heritability}A), 
...
heritability than local heritability (Figure
...
loadings (Figure \ref{fig:loading_heritability}B),
...
each tissue (Figure \ref{fig:loading_heritability}C). This procedure
