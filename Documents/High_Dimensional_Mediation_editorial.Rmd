...
based on equation 2 in Visscher et al. (2015)\cite{pmid25361897}.
...
relevant. The $p$ values for studies without replicates were 
derived from two-sided Welch's t tests. The $p$ value for the
study with replicates was derived from a linear mixed model
using subject ID as the random variable. No adjustments were 
made for multiple comparisons. Source data are provided as 
a Source Data file.
}
