...
0.59. However, when the transcriptome was taken into account, the
partial correlation between \(G_C\) and \(P_C\) was effectively zero
(0.14). \(P_C\) captured 30\% of the overall trait variance, and its
...
plot). This pattern contrasts with transcripts nominated by TWAS (Fig.
