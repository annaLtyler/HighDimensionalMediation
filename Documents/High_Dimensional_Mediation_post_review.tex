...
(\(p < 2\times10^{-16}\)) (Fig. \ref{fig:human_translation}A),
...
statistically different from zero (Adipocytes: \(p = 0.08\),
...
for delta- (\(p < 2\times10^{-16}\)) and endothelial-cell (\(p = 0.01\))
...
the hypothtsis that HDMA identified transcripts that truly mediate
