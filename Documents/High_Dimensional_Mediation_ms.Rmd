...
gene regulation to trait variation in a genetically diverse 
mouse model of diet-induced obesity and metabolic disease. It 
has frequently been assumed that gene regulation in \textit{cis} 
is the primary driver of trait variation, but attempts to use 
local gene regulation to explain phenotypic variation have had 
limited success \cite{pmid32912663, pmid36515579}. In recent 
years, the discussion has turned to distal gene regulation 
\cite{pmid32424349, pmid37857933, pmid31051098}, which is more 
complex to identify, but may be an important component of trait 
heritability. 

With HDMA we identified tissue-specific composite transcripts 
that mediated the effects of genetic background on trait variation 
in the DO mice. The transcripts that contributed the most to the
...
local gene regulation alone was unable to predict obsesity in 
...
The observation that distal gene regulation is primarily 
responsible for expression-mediated trait variation is supported
in human studies. Transcripts with low local heritability have
been shown to explain more expression-mediated disease heritability 
than transcripts with high local heritability \cite{pmid32424349}.
Further, studies suggest that genes that are near GWAS hits and 
