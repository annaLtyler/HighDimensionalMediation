...
$G_C$ and $P_C$ was effectively 0 (`r signif(var.pcor["Causal", "Outcome"], 2)`).
...
`r signif(comp.trait.herit[2], 2)`, which was higher than any of the individual 
traits (Fig. \ref{fig:trait_overview}F). Thus, HDMA identified a maximally 
heritable metabolic trait that was perfectly mediated by a highly heritable 
...
Using HDMA, we identified a highly heritable comopsite trait 
(`r signif(comp.trait.herit[1], 2)`\% heritable) that explained 
