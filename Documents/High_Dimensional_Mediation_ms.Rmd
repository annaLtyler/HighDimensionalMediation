...
The loading of each transcript indicates how expression 
levels influence metabolic phenotypes. For transcripts with 
positive loadings, expression was positively correlated with 
metabolic index, whereas for transcripts with negative loadings,
expression was negatively correlted with metabolic index. 
If local regulation is the predominant factor influencing
gene expression, we should be able to combine loadings and 
eQTLs to predict metabolic index in another population.
