...
transcripts in each of the four tissues (Fig. \ref{fig:eQTL}). 
Significant local eQTLs far outnumbered distal eQTLs 
(Fig. \ref{fig:eQTL}F) and tended to be shared across 
tissues (Fig. \ref{fig:eQTL}G) whereas the few 
significant distal eQTLs we identified tended to be 
tissue-specific (Fig. \ref{fig:eQTL}H)
...
Genes in the KEGG oxidative phosphorylation pathway in mice were 
...
metabolic index (Supp. Fig. \ref{fig:oxPhos}). Consistent with
this observations, it has been shown previously that mouse strains 
with greater thermogenic potential are also less susceptible to obesity 
on a high-fat diet \cite{pmid18492779}.
