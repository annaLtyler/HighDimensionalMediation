...
such as drug prioritization using the CMAP databases and 
gene set enrichment analysis (GSEA). We also paired these
vectors with about cell-type specific genes to generate 
hypotheses about cell composition in individual tissues. 
Combining the multi-tissue, transcriptome-wide weighted
vectors with public data bases and data sets provides 
a path for generating a wide range of testable hypotheses.

Gene expression derived from patient biopsies confirmed 
