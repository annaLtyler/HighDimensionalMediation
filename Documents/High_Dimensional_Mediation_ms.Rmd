...
analyzed simultaneously with a explicit relationships. 
...
by HDMA, we are explaining primarily transcriptional mediation
...
### Distally heritable transcriptomic signature reflects changes in composition of adipose tissue and islets
...
### Distally heritable transcriptomic signature translates to human disease

Ultimately, the distally heritable transcriptomic signature 
that we identified in DO mice will be useful if it teaches
