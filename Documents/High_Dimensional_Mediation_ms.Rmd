...
phenome ($P_C$) where $T_C$ perfectly mediates the effect of $G_C$ 
on $P_C$. Each vector is of length $n$ where $n$ is the number of 
individual mice. Fig. \ref{fig:workflow}A shows the partial correlations 
between all pairs of composite vectors. The partial correlation $r$ between 
$G_C$ and $T_S$ was 0.46, and the partial correlation between $T_S$ and $P_S$ 
...
$0.71 \pm 0.08$, which was higher than any of the individual traits 
