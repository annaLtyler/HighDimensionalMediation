...
The local heritability of transcripts was negatively correlated 
with their trait relevance. We defined trait relevance as the 
maximum correlation of a transcript across all traits (Fig. 
\ref{fig:motivation}B). This suggests that the more local 
...
genome kernel, $T_K$ = transcriptome kernel; $P_K$ = phenome kernel). 
