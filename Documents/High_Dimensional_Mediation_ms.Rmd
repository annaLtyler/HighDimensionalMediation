...
(XXX/%), or diabetes (XXX/%) according to previously developed 
cutoffs (pre-diabetes: FBG $\geq 250$ mg/dL, diabetes: FBG $\geq 300$ mg/dL) 
...
(Fig. \ref{fig:trait_overview}D $R^2 = 0.31$) and fasting
blood glucose (FBG) (Fig. \ref{fig:trait_overview}E, $R^2 = 0.21$) 
