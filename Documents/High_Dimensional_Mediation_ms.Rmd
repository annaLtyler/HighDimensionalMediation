...
that the relationship among genetic variants, the regulation 
of gene expression, and organism-level traits is more complex 
than the simple, local model.
...
We generated two complementary data sets in mice: A discovery data 
...
CC-RIX carry the same founder alleles as the DO. Thus, local gene r
egulation is expected to match between the populations. However, because 
...
between populations. Together, these data enable a comprehensive view 
