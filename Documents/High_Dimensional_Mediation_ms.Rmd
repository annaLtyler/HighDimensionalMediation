...
index and greater metabolic disease, including higher body weight 
and higher insulin resistance. We refer to $P_C$ as the metabolic 
disease index (MDI) going forward. Traits contributing the least 
to the MDI were measures of cholesterol and pancreas composition. 
Thus, when we interpret the transcriptomic signature identified by 
HDMA, we are explaining primarily the putative transcriptional 
...
with a higher MDI. It is well established that 
...
in the abundance of those cell types is not a mediator of MDI.
...
that mice with higher MDI had inherited a higher proportions 
...
major contributors to MDI. This is further consistent with 
...
data with calculated eQTLs are available on the Synapse 
