...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#set options to keep the auxiliary files. }
\CommentTok{\#we use these to reference the figure labels}
\CommentTok{\#from the manuscript file}
\FunctionTok{options}\NormalTok{(}\AttributeTok{tinytex.clean =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
