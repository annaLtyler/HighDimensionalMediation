...
resistance in the DO population (Fig. \ref{fig:toa}).

Many of these modules, such as leptin signaling in adipose tissue
{[}cite{]} and skeletal muscle {[}cite{]}, as well as apelin signaling
{[}cite{]} have well established functional roles in diabetes and
obesity.
