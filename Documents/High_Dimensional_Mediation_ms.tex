...
transcript that explained 30\% of trait variation in a genetically
diverse mouse model of diet-induced obesity and metabolic disease. The
composite transcript was interpretable in terms of enriched biological
processes, and predicted obesity status in an independent mouse cohort
as well as human cohorts with measured gene expression. Transcripts
contributing most strongly to this mediator tended to have complex,
distal regulation distributed throughout the genome. These results
suggest that the majority of heritable transcript variation mediating
trait variation is regulated in a complex manner, but is nonetheless
