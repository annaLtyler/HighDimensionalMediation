...
The trait correlatoins (Fig. \ref{fig:trait_overview}G) showed that most
of the metabolic trait pairs were only modestly correlated, which
combined with the trait decomposition (Supp. Fig.
\ref{fig:trait_decomp}), suggest complex relationships among the
