...
pancreatic islets, liver, and skeletal muscle. Taken together, these
data enable a comprehensive view into the genetic architecture of
metabolic disease.
...
partial correlation between \(G_S\) and \(P_S\) was effectively 0
(0.039). The estimated heritability of the composite phenome was
heritability of 0.71 \(\pm\) 0.084, which was higher than any of the
individual traits (Fig. \ref{fig:trait_overview}F). Thus, HDMA
identified a maximally heritable metabolic trait that is perfectly
...
\tightlist
\item
  how much trait variance does composite trait explain? sum over
  correlations with all PCs
\item
