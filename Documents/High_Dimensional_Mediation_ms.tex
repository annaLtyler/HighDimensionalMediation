...
can be analyzed as a whole, or dissected to analyze transcripts with
...
peripheral genes as far as loading, but that should not necessarily be
...
distal eQTL (Supplemental Figure XXX). Thus, although distal regulation
