...
mediators of the effect of genetics on metabolic index. Large positive
...
pointed to an axis of inflammation and metabolism that was strongly
related to metabolic index (Supp. Fig. \ref{fig:top_enrich_kegg} and
\ref{fig:top_enrich_go}). Processes and pathways associated with
...
inflammatory pathways was associated with a higher metabolic index.
