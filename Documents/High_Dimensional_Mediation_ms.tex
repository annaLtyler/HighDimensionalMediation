...
perfectly mediated by a transcriptomic signature. We found these
...
HDMA transcriptomic signatures predicted obesity in an independent
population of Collaborative Cross recombinant inbred (CC-RIX) mice and
in human subjects. In contrast, local eQTL were unable to predict
obesity in the CC-RIX mice. Together our results suggest that both the
...
Despite the great promise of these methods, their efficacy has been
limited. The vast majority of complex trait heritability remains
unexplained {[}REF{]}, implicating a subtler genetic architecture than
assumed. Ineed, although trait-associated variants tend to lie in
...
traits, we have studied diet-induced obesity and metabolic disease as an
...
estimated heritability was 0.71 \(\pm\) 0.084\%, which was higher than
any of the measured traits (Fig. \ref{fig:trait_overview}F). Thus, HDMA
...
variation have yet to explain much trait heritability. In recent years,
