...
between all pairs of composite vectors. The partial correlation \(r\)
between \(G_C\) and \(T_S\) was 0.46, and the partial correlation
...
\(P_S\) was effectively 0 (-0.01). The estimated heritability of the
composite phenome was heritability of 0.71 \(\pm\) 0.0837393, which was
