...
We placed a population of 500 male and female mice from generations 
18, 19, and 21 on a high-fat, high-sugar diet to induce diet-associated 
obesity and metabolic disease as described previously \cite{pmid29567659}. 
Over the experimental period of 18 weeks multiple metabolic traits were 
measured longitudinally, including body weight, plasma levels of insulin 
and glucose, and plasma lipids. At the end of the experiment, we used 
RNASeq to measure gene expression in 384 mice in four tissues relevant 
to metabolic disease: adipose tissue, pancreatic islets, liver, and skeletal 
muscle. The mice were also genotyped using the Mouse Universal Genotyping Array 
(GigaMUGA).
