...
\url{https://www.synapse.org} in the file 1b.Trait_Selection.Rmd 
(synID: syn63335511).
...
(HDMA). Then, we demonstrate how to \textit{kernelize} HDMA to limit 
dimensionality of the model and enable non-linear HDMA models.
...
The general log-likelihood function for an SEM is given by \cite{bollen2014structural}
...
analytic formula.
 ...
 All code required to run HDMA is available at Synapse \url{https://www.synapse.org},
 synID: syn63335506.
