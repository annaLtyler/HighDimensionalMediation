...
## Processed Data
We downloaded genotypes, phenotypes, and pancreatic islet gene expression 
...
A complete description of trait filtering can be found on Synapse
...
The variance of the predicted transcript is its local heritability. We then 
...
methods, including canonical correlation analysis (CCA) and partial 
...
model by requiring that loading vectors lie in the span of the 
...
other linear models, including CCA [REF], linear regression [REF], and 
classification [REF].
