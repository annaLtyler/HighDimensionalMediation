...
0 (Fig. \ref{fig:human_translation}A) ($p < 2\times10^{-16}$), 
...
for delta- and endothelial-cell specific genes were significantly 
less than 0 ($p < 2\times10^{-16}$) (Fig. \ref{fig:human_translation}B). 
