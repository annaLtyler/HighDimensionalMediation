...
\urlstyle{same}
\hypersetup{
  pdftitle={Detailed Methods for Transcripts with high distal heritability mediate genetic effects on complex traits},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Detailed Methods for Transcripts with high distal heritability
...
\subsection{Trait selectionin DO}\label{trait-selectionin-do}
...
\textit{multiblock} methods, including canonical correlation analyssis
...
other linear models, including CCA \cite{}, linear regression {[}REF{]},
and classification {[}REF{]}.
