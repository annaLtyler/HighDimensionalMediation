...
%DIF DEL High_Dimensional_Mediation_post_review.tex    Tue Mar 25 14:24:14 2025
%DIF ADD High_Dimensional_Mediation_post_review2.tex   Mon Mar 31 10:14:10 2025
...
structure between pairs of physiological traits. \DIFaddbeginFL \DIFaddFL{The lower triangle 
...
estimated heritability of each trait. }\DIFaddendFL BMD - bone mineral density,
...
\DIFdelbegin \DIFdel{To comprehensively assess the genetic control }\DIFdelend \DIFaddbegin \DIFadd{It is widely assumed that variation in traits is mediated through local
regulation }\DIFaddend of gene expression\DIFdelbegin \DIFdel{in
metabolic disease we measured
overall gene expression via bulk RNA-Seq
in adipose, islet, liver,
and skeletal muscle in }\DIFdelend \DIFaddbegin \DIFadd{. To test this assumption, we measured
transcriptome-wide gene expression in four tissues--adipose, liver,
pancreatic islet, and skeletal muscle--in }\DIFaddend the DO cohort\DIFdelbegin \DIFdel{(Supp. Fig. \ref{fig:eQTL}). We performed eQTL analysis using R/qtl2
}\DIFdelend \DIFaddbegin \DIFadd{. (Basic results
from a standard eQTL analysis }\DIFaddend \cite{pmid30591514} (Methods) \DIFdelbegin \DIFdel{and identified both local and distal eQTLs
for transcripts in each of the four tissues (}\DIFdelend \DIFaddbegin \DIFadd{are
available in }\DIFaddend Supp. Fig. \ref{fig:eQTL}\DIFdelbegin \DIFdel{B-E). Significant local eQTLs far outnumbered distal eQTLs
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{). We estimated the local genetic
contribution to each transcript as the variance explained by the
haplotype probabilities at the genetic marker closest to the gene
transcription start site. }\DIFaddend We estimated the \DIFdelbegin \DIFdel{heritability of each transcript in terms of local and
all non-local (distal) genetic factors (}\DIFdelend \DIFaddbegin \DIFadd{distal heritability as the
heritability of the residuals after local haplotype had been accounted
for (}\DIFaddend Methods). \DIFaddbegin \DIFadd{Importantly, this estimate was not based on distal eQTL,
but rather the unlocalized contribution of the genome after removing the
local genetic effect.
}

\DIFaddend Overall, local and distal genetic factors contributed approximately
...
transcript (Fig, \ref{fig:motivation}A). \DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{The equal }\DIFdelend \DIFaddbegin \DIFadd{This 50\% }\DIFaddend contribution of local
\DIFdelbegin \DIFdel{and distal genetic variants to the
heritability of }\DIFdelend \DIFaddbegin \DIFadd{genetic variation to }\DIFaddend transcript abundance contrasts with findings in
humans in which local variants have been found to explain \DIFaddbegin \DIFadd{only }\DIFaddend 20-30\%
of total heritability, while distal \DIFdelbegin \DIFdel{variants }\DIFdelend \DIFaddbegin \DIFadd{effects }\DIFaddend explain the remaining
...
human populations \DIFdelbegin \DIFdel{. Each genetic marker }\DIFdelend \DIFaddbegin \DIFadd{and to the high degree of confidence with which we can
estimate ancestral haplotypes in this population. At each position }\DIFaddend in
the mice \DIFdelbegin \DIFdel{captures }\DIFdelend \DIFaddbegin \DIFadd{we can estimate ancestral haplotype with a high degree of
accuracy. Haplotype at any given genetic marker captures genomic
}\DIFaddend information from a \DIFdelbegin \DIFdel{larger genomic region than each
genetic marker}\DIFdelend \DIFaddbegin \DIFadd{relatively large genomic region surrounding each
marker. In contrast, there is a much higher degree of recombination }\DIFaddend in
human populations \DIFdelbegin \DIFdel{, and thus }\DIFdelend \DIFaddbegin \DIFadd{and ancestral haplotypes are more numerous and more
difficult to estimate than in the mice. Thus in the mice, each marker
}\DIFaddend may capture more local regulatory \DIFdelbegin \DIFdel{variants than SNPs }\DIFdelend \DIFaddbegin \DIFadd{variation than SNPs or estimated
haplotypes }\DIFaddend capture in humans. It has been found that transcripts with
...
\DIFdelbeginFL \DIFdelFL{Arrows indicate the median of each distribution. }\DIFdelendFL The relationship between (\textbf{B.}) local and (\textbf{C.}) 
...
tissues. This finding is \DIFaddbegin \DIFadd{also }\DIFaddend consistent with previous observations that
...
phenome space and \DIFdelbegin \DIFdel{and }\DIFdelend ensure that these three omic spaces have the same
...
\DIFdelbeginFL \DIFdelFL{independently normalized and converted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{kernelized }\DIFaddendFL to \DIFdelbeginFL \DIFdelFL{kernel }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{yield single }\DIFaddendFL matrices representing the 
\DIFdelbeginFL \DIFdelFL{pairwise }\DIFdelendFL relationships between \DIFaddbeginFL \DIFaddFL{all }\DIFaddendFL individuals for each data modality 
...
were \DIFdelbeginFL \DIFdelFL{$G_C$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$G_c$}\DIFaddendFL , $T_C$, and $P_C$. The partial correlations 
$\rho$ between these vectors indicated perfect mediation. 
Transcript and trait loadings were calculated as described 
in the \DIFdelbeginFL \DIFdelFL{Methods}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{methods}\DIFaddendFL . \textbf{B.} The null distribution of the path 
coefficient derived from 10,000 permutations\DIFdelbeginFL \DIFdelFL{compared to the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. The }\DIFaddendFL observed \DIFdelbeginFL \DIFdelFL{path 
coefficient }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{model
}\DIFaddendFL (red\DIFdelbeginFL \DIFdelFL{line}\DIFdelendFL ) \DIFaddbeginFL \DIFaddFL{is compared to models derived from exclusively distal 
(gray) or local genetic effects (brown)}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{The similarity of 
the observed and distal models indicates the full model is 
dominated by distal genetic effects. }\DIFaddendFL \textbf{C.} 
The null distribution of the $G_C$-$T_C$ correlation vs. 
the $T_C$-$P_C$ correlation\DIFdelbeginFL \DIFdelFL{compared with }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{. Comparisons are shown 
to }\DIFaddendFL the observed \DIFdelbeginFL \DIFdelFL{value 
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{values }\DIFaddendFL (red\DIFdelbeginFL \DIFdelFL{dot}\DIFdelendFL )\DIFaddbeginFL \DIFaddFL{, and those derived from the 
distal-only model (gray) and the local-only model (brown)}\DIFaddendFL .
}
\label{fig:workflow}
\end{figure}
...
data is indicated by a red \DIFdelbegin \DIFdel{line}\DIFdelend \DIFaddbegin \DIFadd{arrow}\DIFaddend . The observed path coefficient was well
...
\DIFadd{To test whether the presence of local eQTLs affected the result, we
...
\DIFadd{Further, the \(G_C\)-\(T_C\) and \(T_C\)-\(P_C\) correlations derived
...
}\DIFaddend results suggest that \DIFdelbegin \DIFdel{these composite vectors }\DIFdelend \DIFaddbegin \DIFadd{composite vectors derived from the measured
transcriptomic kernel }\DIFaddend represent genetically determined variation in
phenotype that is mediated through genetically determined variation in
transcription\DIFaddbegin \DIFadd{, and that this genetically deremined variation in
transcription is largely driven by distal factors}\DIFaddend .
...
trait. \textbf{B.} Phenotype scores \DIFdelbeginFL \DIFdelFL{(MDI) }\DIFdelendFL across individuals. Individuals with large 
positive \DIFdelbeginFL \DIFdelFL{MDI }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{phenotype scores }\DIFaddendFL had higher body weight and insulin resistance 
than average. Individuals with large negative \DIFdelbeginFL \DIFdelFL{MDI }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{phenotype scores }\DIFaddendFL had lower 
...
and insulin resistance. \DIFaddbeginFL \textbf{\DIFaddFL{E.}} \DIFaddFL{Scatter plots showing correlations between 
...
(Fig. \ref{fig:interpretation}\DIFdelbegin \DIFdel{C}\DIFdelend \DIFaddbegin \DIFadd{C-D}\DIFaddend ). Conversely, large negative loadings
...
diet) (Fig. \ref{fig:interpretation}\DIFdelbegin \DIFdel{C). }\DIFdelend \DIFaddbegin \DIFadd{C-D). Fig. \ref{fig:interpretation}D
...
can be seen in Supp. Fig. \ref{fig:transcript_loading_comparison}. }\DIFaddend We
used gene set enrichment analysis (GSEA) \cite{fgsea, 
...
\DIFdelbegin \DIFdel{\ref{fig:composite_cor}}\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:interpretation}E}\DIFaddend ).
...
\subsection{Data \DIFdelbegin \DIFdel{and Code
}\DIFdelend Availability}\DIFdelbegin %DIFDELCMD < \label{data-and-code-availability}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \label{data-availability}
\DIFaddend 
...
\DIFaddbegin \subsection{\DIFadd{Code Availability}}\label{code-availability}

\DIFaddend \textbf{Code}: All code used to run the analyses reported here are
...
Each dot represents an eQTL with a minimum LOD score of \DIFdelbeginFL \DIFdelFL{8. }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{8, which 
represents a genome-wide permutation-based threshold of p < 0.01. }\DIFaddendFL The 
...
\begin{figure}[ht!]
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{Figures/Supp_Fig_Composite_Vector_Correlations.pdf} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{Figures/Supp_Fig_transcript_load_comparison.pdf} 
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Scatter plots showing correlations between composite vectors 
for the genome ($G_C$), the transcriptome ($T_C$), }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Direct comparisons of transcript loadings across tissues. }\textbf{\DIFaddFL{A.}}
\DIFaddFL{Distributions of transcript loadings are shown as density curves }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{the phenome ($P_C$)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are 
differentially colored to indicate tissue}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{The $G_C$ - $T_C$ correlation is high, }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Transcripts in adipose tissue had 
both }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{$T_C$ - $P_C$ correlation is high,
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{largest positive }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{there is no significant correlation between $G_C$ and $P_C$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{negative loadings}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{This correlation
structure is consistent with perfect mediation}\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{B.}} \DIFaddFL{Direct comparison
of absolute values of transcript loadings across tissues}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Transcripts in adipose
tissue had the largest loadings overall, while those in skeletal muscle had the
smallest.
}\DIFaddendFL }
\DIFdelbeginFL %DIFDELCMD < \label{fig:composite_cor}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:transcript_loading_comparison}
